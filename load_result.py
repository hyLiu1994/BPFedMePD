...
algorithm_list = ["FedAvg", "FedPer", "FedRep", "LGFedAvg", "pFedBayes", "BPFedPD","FedSOUL"]
# algorithm_list = ["FedPer", "FedRep", "pFedBayes", "BPFedPD"]
# algorithm_list = ["LGFedAvg"]
