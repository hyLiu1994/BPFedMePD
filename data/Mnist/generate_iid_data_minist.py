...
data_size_str="small"
train_data_per_client_per_label = 50
test_data_per_client_per_label = 950

# data_size_str="large"
# train_data_per_client_per_label = 900
# test_data_per_client_per_label = 300
...
train_path = 'data/train/mnist_train_' + data_size_str + '.json'
test_path = 'data/test/mnist_test_' + data_size_str + '.json'
